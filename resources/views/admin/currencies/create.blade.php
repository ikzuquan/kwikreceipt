    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.currencies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precision') ? 'is-invalid' : '' }}" type="number" name="precision" id="precision" value="{{ old('precision', '') }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('symbol_first') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="symbol_first" id="symbol_first" value="1" {{ old('symbol_first', 0) == 1 || old('symbol_first') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thousand_seperator') ? 'is-invalid' : '' }}" type="text" name="thousand_seperator" id="thousand_seperator" value="{{ old('thousand_seperator', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('decimal_mark') ? 'is-invalid' : '' }}" type="text" name="decimal_mark" id="decimal_mark" value="{{ old('decimal_mark', '') }}" required>
