    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tel') ? 'is-invalid' : '' }}" type="text" name="tel" id="tel" value="{{ old('tel', $setting->tel) }}" required>
                @if($errors->has('tel'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $setting->fax) }}">
                @if($errors->has('fax'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('currency') ? 'is-invalid' : '' }}" name="currency_id" id="currency_id" required>
                    @foreach($currencies as $id => $currency)
                        <option value="{{ $id }}" {{ (old('currency_id') ? old('currency_id') : $setting->currency->id ?? '') == $id ? 'selected' : '' }}>{{ $currency }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('receipt_prefix') ? 'is-invalid' : '' }}" type="text" name="receipt_prefix" id="receipt_prefix" value="{{ old('receipt_prefix', $setting->receipt_prefix) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_digit') ? 'is-invalid' : '' }}" type="number" name="number_digit" id="number_digit" value="{{ old('number_digit', $setting->number_digit) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('next_number') ? 'is-invalid' : '' }}" type="number" name="next_number" id="next_number" value="{{ old('next_number', $setting->next_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $setting->notes) }}</textarea>
                @if($errors->has('notes'))
